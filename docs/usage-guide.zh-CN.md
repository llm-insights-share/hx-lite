...
**详细 walkthrough**：[场景 19 组织级 PRD 与架构设计](examples/19-组织级PRD与架构设计.md) · [场景 11 自定义需求产出模板](examples/11-自定义需求产出模板.md) · **[产品经理需求文档编写使用手册](pm-req-manual.zh-CN.md)**
...
**详细 walkthrough**：[场景 19](examples/19-组织级PRD与架构设计.md) · [场景 12 自定义概要设计产出模板](examples/12-自定义概要设计产出模板.md) · **[架构师概要设计使用手册](arch-hld-manual.zh-CN.md)**
