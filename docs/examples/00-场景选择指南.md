...
| 日常功能开发（Cursor） | 旅程 2 | **[开发人员应用交付使用手册](../dev-manual.zh-CN.md)** · [02](02-标准功能开发全流程.md) |
...
| 全栈 TL（前后端多人） | 旅程 3 | **[开发人员应用交付使用手册](../dev-manual.zh-CN.md)** · [14](14-企业全栈多角色交付.md) |
...
| 质量 / 效能负责人 | 旅程 4 | [07](07-steering-质量治理.md) · **[Rubric 编写与维护使用手册](../rubric-manual.zh-CN.md)** |
...
| 2 | [02 标准功能全流程](02-标准功能开发全流程.md) · [开发人员手册](../dev-manual.zh-CN.md) | 第一个 change 走完 propose→archive |
...
| 场景 | 何时选 |
| --- | --- |
| [02 标准功能](02-标准功能开发全流程.md) · [开发人员手册](../dev-manual.zh-CN.md) | 常规需求，`standard` profile |
...
| [12 设计模板](12-自定义概要设计产出模板.md) | 定制 design 结构与 `/hx-dev-design` |
