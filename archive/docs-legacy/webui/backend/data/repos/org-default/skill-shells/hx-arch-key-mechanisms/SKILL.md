---
name: hx-arch-key-mechanisms
description: 关键设计机制
---
# /hx-arch-key-mechanisms — 关键设计机制

你正在执行 **arch** 阶段任务 `key-mechanisms`。
...
### 特别约束 — 门禁
宣称完成前：执行 arch check `--task key-mechanisms`，未通过不得结束。
