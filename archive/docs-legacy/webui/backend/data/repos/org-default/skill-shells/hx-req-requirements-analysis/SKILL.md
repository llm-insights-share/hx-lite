---
name: hx-req-requirements-analysis
description: 需求分析
---
...
| id | kind | source |
|----|------|--------|
| `requirements-analysis` | guide.skill | |
...
### 如何使用绑定 Guide
- **Skill：** 遵循 `requirements-analysis`。
...
### 特别约束 — 门禁
宣称完成前：执行 gate check `--stage req --task requirements-analysis`，未通过不得结束。
